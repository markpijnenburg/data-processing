window.onload = function() {
  ...
  // D3 Projection
  var projection = d3.geo.albersUsa() // translate to center of screen
    .scale([850])
  ...
  // var colorScale = ["#FF999A", "#FF6666", "#FF3334", "#FF1919", "#FE0000"];
  // var colorGender = ["#FE86F9", "#39CCFF"];
  ...
  function linkedScatterplot(stateHomicides, drawn) {
    ...
    var widthScatterplot = 1000 - margin.left - margin.right;
    ...
    function updateScatterplot(stateHomicides) {
      ...
      // // stateHomicides = convertData(stateHomicides);
      // // console.log(stateHomicides);
      // var scatterplot = d3.select(".y axis").selectAll("circle").data(stateHomicides);
      //
      // // console.log("test");
